          ...
          <div className="flex flex-col h-full border-l border-ln-gray-30">
            <div className="h-1/2 flex flex-col border-b border-ln-gray-20">
              <div className="relative px-2 py-3.5 border-b border-ln-gray-20 shrink-0">
                ...
                <input
                  className="w-full bg-ln-gray-02 border-ln-gray-20 border rounded-md text-xs pl-7 pr-2 text-ln-gray-80 placeholder:text-ln-gray-50 focus:outline-none focus-visible:ring-1 focus-visible:ring-ln-primary-50 h-8"
                  placeholder="Search..."
                  value={searchQuery}
