            ...
            <PillManager.Label
              ...
              render={
                row.id === "groups" ? (
                  ...
                  <div className="flex gap-1 items-center justify-between py-2 px-2 text-ln-gray-80">
                    <div className="flex gap-1 items-center text-sm font-(--ln-typeface)">
                      <Measure />
                      Aggregations
                    </div>
            ...
            {((row.id === "groups" && showGroups) ||
              ...
              <PillManager.Container className="relative">
                {row.id === "groups" && row.pills.every((x) => !x.active) && (
                  <div className="absolute w-full -top-2.5 h-full flex items-center justify-center text-ln-gray-70">
