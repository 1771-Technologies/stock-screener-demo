...
export function ColumnManagerDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} modal lightDismiss>
      ...
      >
        ...
        >
          <rect
            ...
            height="15"
            rx="3"
            transform="matrix(1 0 0 -1 2.5 17.5)"
            stroke="currentcolor"
            stroke-width="1.5"
      ...
      <Dialog.Container
        className="w-full max-w-[80vw] md:max-w-[700px] h-[520px] px-0 flex flex-col top-1/3"
      ...
      >
        ...
        <div className="relative px-3 py-3.5 border-b border-ln-gray-30 shrink-0">
          ...
          <input
            className="w-full bg-ln-gray-02 border border-ln-gray-20 rounded-md text-xs py-2 pl-7 pr-2 text-ln-gray-80 placeholder:text-ln-gray-50 focus:outline-none focus-visible:ring-1 focus-visible:ring-ln-primary-50 h-8"
            placeholder="Search..."
            value={searchQuery}
