...
import { getSortOnOptionsForType, type SortOnOption } from "./sort-on-options";
...
export function SortDialogContent({
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:grid md:grid-cols-[1fr_1fr_100px_auto_auto] max-h-[60vh] px-[18px] py-3 overflow-y-auto">
